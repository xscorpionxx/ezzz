      ...
      child: Form(key: key,
        child: ListView(children: [
          ...
          ,Directionality(textDirection: TextDirection.rtl,
            child: Container(padding:EdgeInsets.only(right: MediaQuery.of(context).size.width*0.02),decoration: BoxDecoration(border: Border.all(color: Colors.black38),borderRadius: BorderRadius.circular(5)),margin: EdgeInsets.only( top:MediaQuery.of(context).size.height*0.01 ,left:  MediaQuery.of(context).size.width*0.1,right: MediaQuery.of(context).size.width*0.1),child: TextFormField(
              ...
              paste: false,
              selectAll: false,
            ),inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'^[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FFa-zA-Z]+[\u0600-\u065F\u066A-\u06EF\u06FA-\u06FFa-zA-Z-_]*$')),],style: TextStyle(fontSize: MediaQuery.of(context).textScaleFactor*13),decoration: InputDecoration(border: InputBorder.none, hintStyle: TextStyle(fontSize: MediaQuery.of(context).size.height*0.015),hintText: "اسم المكان "),
            )),
          ),
        ...
        ,Container(child: Divider(color: Colors.black54,),margin: EdgeInsets.only(right: MediaQuery.of(context).size.width*0.1,left:MediaQuery.of(context).size.width*0.1)),
          ...
          , InkWell(onTap: ()=>chooseimage(null),
            ...
            ):InkWell(onTap: ()=>chooseimage(null),child: Image(fit: BoxFit.fill,image: NetworkImage(mainphoto),))) ),
          ...
          //  Expanded(child:InkWell(onTap: ()=>chooseimage(0),
           //   child: Container(margin: EdgeInsets.all( MediaQuery.of(context).size.width*0.01 ),child: images[0] != null?Container(
            //    child:InkWell(onTap: ()=>chooseimage(0),child: Image( fit: BoxFit.fill,image: FileImage(images[0]),)),
            //  ) :photos[0] ==null?
            //  DottedBorder(color: Colors.black.withOpacity(0.2),
           //     child: Center(child: Container(child:  Icon(Icons.add,color: Colors.blue,)),),
           //   ):InkWell( onTap: ()=>chooseimage(0),child: Image(fit: BoxFit.fill,image: NetworkImage(photos[0]),)) ),
           // )),
          //  Expanded(child:InkWell(onTap: ()=>chooseimage(1),
           ...
           //     child:InkWell( onTap: ()=>chooseimage(1),child: Image( fit: BoxFit.fill,image: FileImage(images[1]),)),
           //   ) : photos[1] ==null?
           //   DottedBorder(color: Colors.black.withOpacity(0.2),
           //     child: Center(child: Container(child:  Icon(Icons.add,color: Colors.blue,)),),
           //   ):InkWell( onTap: ()=>chooseimage(1),child: Image(fit: BoxFit.fill,image: NetworkImage(photos[1]),))),
          // )),
          ...
          //    child: Container(margin: EdgeInsets.all( MediaQuery.of(context).size.width*0.01 ),child: images[2] != null?Container(
           //     child:InkWell( onTap: ()=>chooseimage(2),child: Image( fit: BoxFit.fill,image: FileImage(images[2]),)),
           //   ) : photos[2] ==null?
            //  DottedBorder(color: Colors.black.withOpacity(0.2),
           //     child: Center(child: Container(child:  Icon(Icons.add,color: Colors.blue,)),),
           ///   ):InkWell(onTap: ()=>chooseimage(2),child: Image(fit: BoxFit.fill,image: NetworkImage(photos[2]),)) ),
          //  )),
          ...
          //      child:InkWell(onTap: ()=>chooseimage(3),child: Image( fit: BoxFit.fill,image: FileImage(images[3]),)),
          //    ) : photos[3] ==null?
          //    DottedBorder(color: Colors.black.withOpacity(0.2),
          //      child: Center(child: Container(child:  Icon(Icons.add,color: Colors.blue,)),),
          //    ):InkWell(onTap: ()=>chooseimage(3),child: Image(fit: BoxFit.fill,image: NetworkImage(photos[3]),)) ),
         //   )),
         ...
         //     child: Container(margin: EdgeInsets.all( MediaQuery.of(context).size.width*0.01 ),child: images[4] != null?Container(
          //      child:InkWell(onTap: ()=>chooseimage(4),child: Image( fit: BoxFit.fill,image: FileImage(images[4]),)),
          //    ) : photos[4] ==null?
          //    DottedBorder(color: Colors.black.withOpacity(0.2),
         //       child: Center(child: Container(child:  Icon(Icons.add,color: Colors.blue,)),),
         ///     ):InkWell(onTap: ()=>chooseimage(4),child: Image(fit: BoxFit.fill,image: NetworkImage(photos[4]),)) ),
         //   ))
          ...
          ,InkWell(onTap:()=> addservice3logic
              .editservice3(service["ID"], key, type.toString(), name.text, region2, region3, address.text, masaha.text, numofroof.text, numofroom.text, fornum.text, wcs.text, ketchins.text, price1.text, price2.text, detail.text, features, images , image, accept ,locationurl.text),
