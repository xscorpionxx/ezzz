    ...
    Container(
      child:ListView(
        children:[
          ...
          Container(height: MediaQuery.of(context).size.height*0.25,child: ListView.builder(itemCount: data["Products"].length ,itemBuilder: (context,i){
            return Container(decoration: BoxDecoration(border: Border.all(color: Colors.black54)),
              margin: EdgeInsets.only( top: MediaQuery.of(context).size.height*0.01,left:MediaQuery.of(context).size.width*0.05 ,right: MediaQuery.of(context).size.width*0.05) ,child: Row(children: [
                Expanded(child:Container(margin: EdgeInsets.only(left: MediaQuery.of(context).size.width*0.02),child: Directionality(textDirection: TextDirection.rtl,child: Text(data["Products"][i]["SalePrice"].toString() + 'ريال',style: TextStyle(fontSize: MediaQuery.of(context).size.height*0.02,color: Colors.blue))),) ),
                Expanded(flex: 2,child:Container(alignment: Alignment.centerRight,child: Column(children: [
                  Container(child: Text(data["Products"][i]["Name"],style: TextStyle(fontSize: MediaQuery.of(context).size.height*0.02)),),
                ...
                Expanded(child:Container(width: MediaQuery.of(context).size.width*0.1,height: MediaQuery.of(context).size.height*0.1,child: Image(fit: BoxFit.fill,image: NetworkImage(data["Products"][i]["Photo"]),),) )
              ],),);
          }),),
